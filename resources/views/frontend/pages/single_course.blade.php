        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-box-single-course">
                    <h1>The Whole title of the course</h1>
                    <h4>Practical screencasts for awesome developers. and some of the description part of the course will be displayed here</h4>
