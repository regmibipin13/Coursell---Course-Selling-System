...
class FillPermissionsForSuscription extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSuscription constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.suscription',
            'admin.suscription.index',
            'admin.suscription.create',
            'admin.suscription.show',
            'admin.suscription.edit',
            'admin.suscription.delete',
            'admin.suscription.bulk-delete',
        ]);
