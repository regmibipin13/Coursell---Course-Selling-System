...
class FillPermissionsForFounder extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFounder constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.founder',
            'admin.founder.index',
            'admin.founder.create',
            'admin.founder.show',
            'admin.founder.edit',
            'admin.founder.delete',
            'admin.founder.bulk-delete',
        ]);
